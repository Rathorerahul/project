...
$min_length = 3;
    ...
    {
	$query = "SELECT * FROM purpleblood WHERE user LIKE '%$search%' or bandname LIKE '%$search%' or email LIKE '%$search%'  or city LIKE '%$search%' or state LIKE '%$search%' or question LIKE '%$search%' or number1 LIKE '%$search%' or number2 LIKE '%$search%'";
